import Emailfind from "../component/emailfindandsendotp";
export default function Changepwd_send_otp() {
  return (
      ...
      <div className="w-11/12  sm:w-2/3 md:w-2/3  lg:w-2/5  xl:w-1/3  bg-white bg-opacity-10 rounded-3xl flex content-center  ">
        <div className=" flex flex-col w-full p-10 lg:p-10 gap-5 ">
          <div className="flex justify-center">
            <h1 className="text-5xl text-white font-bold  ">Change Password</h1>
          </div>
          <Emailfind />
        </div>
      </div>
