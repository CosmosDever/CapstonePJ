...
export default function Sidebar() {
  ...
  if (loading) {
    return (
      <div className=" h-full w-2/5 md:w-1/5 bg-black bg-opacity-10 flex items-center justify-center ">
  ...
  return (
    <>
      <div className="md:hidden ml-5  mt-4  w-full  ">
        <button
      ...
      <div
        className={`fixed h-screen/2 w-full md:hidden text-white  bg-slate-800 bg-opacity-90 md:w-1/5 flex flex-col items-center justify-center ${
          isMobileMenuOpen ? "md:hidden" : "hidden md:flex"
        }`}
      >
        {/* Content mobile menu */}

        <div className="ml-7  mt-4  w-full">
        ...
        <div className="w-full">
          ...
          <button
            className="text-xl flex items-center justify-center w-full gap-2 p-5 hover:bg-[#D9D9D9] hover:bg-opacity-10 hover:border-l-4 hover:border-[#FFC700]   "
      ...
      <div className="max-md:hidden h-full text-white bg-black bg-opacity-10  w-2/5 md:w-1/5 flex flex-col  items-center justify-center ">
        <div className="gap-10 flex flex-col items-center justify-center">
